...
<section class="py-20 bg-tanah text-cream">
	<div class="container-md text-center">
		...
		<p class="prose-body text-cream/80 max-w-xl mx-auto mb-10">
			Siapa pun bisa berkontribusi di Ngadongeng — tidak perlu jadi penulis profesional. Cukup punya
			cerita, niat baik, dan akun gratis.
		</p>
